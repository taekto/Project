        ...
        <ul class="nav justify-content-end">
          ...
          <form method="GET" action="login">
            ...
            <form method="GET" action="logout">
                      	    		<button>
                      	    		<li class="nav-item">
                                                <a class="nav-link" href=""><i class="bi bi-box-arrow-in-right" style="color:blueviolet"></i></a>
                                              </li>
                      	    		</button></form>
        </ul>
      </div>
	  ...
	  <form method="post" action="video">
	    ...
	    <div style="width: 80%; margin: 0 auto;">
          ...
          <div class="box">
          	...
          	<div class = "child">
            		<iframe width="510" height="360" src="https://img.youtube.com/vi/${video.youtubeid }/0.jpg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      	    	<br>
      	    	${video.title }<br>
      	    	${video.part }<br>
      	    	👁  ${video.channelName }
