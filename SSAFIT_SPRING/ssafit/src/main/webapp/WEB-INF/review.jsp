...
<body>
    ...
    <div>
        ...
        <form method="get" action="registform">
			<input type="hidden" name="id" value="${youtubeId}">
      	 	...
      	 	<c:forEach items="${reviews}" var="review" varStatus="vs">
                ...
                <a>
					<form method="get" action="reviewdetail">
						...
						<input type="hidden" name="reviewContent" value="${review.content}">
						<input type="hidden" name="reviewTitle" value="${review.title}">
						<input type="hidden" name="reviewWriter" value="${review.writer}">
